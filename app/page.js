          ...
          <div className="bg-white rounded-lg shadow-2xl max-w-4xl w-full my-8 flex flex-col max-h-[90vh]" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="overflow-y-auto p-8 leading-relaxed text-gray-800">
              ...
              <div className="mt-12">
                ...
                <h4 className="text-lg font-bold mb-4 text-slate-700">SOA Treasurer (Dec 2023 - Dec 2025)</h4>
                ...
                <h4 className="text-lg font-bold mb-4 text-slate-700">SOA Council Member (Dec 2020 - Dec 2023)</h4>
